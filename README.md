...
flowchart TD
    ...
    subgraph BackendAPI["⚙️ FastAPI Backend :8000 (apps/backend/)"]
        direction TB
        MainPy["main.py\n(CORS + Router Mount)"]
    ...
    subgraph VoiceAI["🎙️ On-Device Voice SLM (ai/voice/)"]
...
flowchart LR
    ...
    subgraph BackendLayer["⚙️ Backend Layer (Harsh)"]
        direction TB
...
flowchart TD
    ...
    subgraph ProductionHint["☁️ Production (Referenced)"]
...
flowchart TB
    ...
    subgraph BackendBoundary["⚙️ Backend Domain (Harsh)\napps/backend/"]
...
flowchart LR
    ...
    subgraph DeviceSLM["🎙️ On-Device SLM\n(Language-Only Authority)"]
        direction TB
...
flowchart TD
    ...
    subgraph BackendFeatures["⚙️ Backend Features"]
...
flowchart TD
    ...
    subgraph Backend2["⚙️ apps/backend/ (Harsh)"]
        BERoutes["routes.py"]
        BEServices["services/"]
...
> ⚠️ **Strict Rule**: Team members must NOT edit other domains' folders. Changes to `contracts/` require consensus from all three members. Enforced via [`.github/CODEOWNERS`](.github/CODEOWNERS).
...
flowchart TD
    ...
    StressEval -->|"DTI > 0.40"| STRESSED["⚠️ STRESSED"]
...
flowchart TD
    ...
    subgraph ComplianceLayer["🛡️ Compliance Layer"]
...
```mermaid
flowchart LR
    subgraph Visible["✅ Data SLM CAN Access"]
    ...
    subgraph SLMProcess["🎙️ MiniCPM-5 SLM Process"]
...
flowchart TD
    ...
    subgraph ServiceLayerDB["⚙️ Service Layer"]
...
stateDiagram-v2
    ...
    state Unlocked {
        ...
        Active: ATM ✅ POS ✅ Online ✅
    }

    state Locked {
        [*] --> Blocked
        Blocked: Payment blocked
        Blocked: ATM ❌ POS ❌ Card ❌
    }
...
flowchart TD
    ...
    Layer6 --> Success["✅ Action Executed"]
```
...
flowchart TD
    ...
    StressCheck -->|"tight"| CAUTION["⚠️ CAUTION\n(Flag but allow)"]
...
flowchart TD
    ...
    subgraph ProductionRef["☁️ Production (Referenced)"]
