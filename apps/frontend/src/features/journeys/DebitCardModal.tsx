      ...
      <View style={styles.overlay}>
        <View style={styles.sheet}>
          ...
          <ScrollView style={styles.scrollArea} showsVerticalScrollIndicator={false}>
            ...
            <View style={[styles.visualCard, isLocked && styles.visualCardLocked]}>
              <View style={styles.cardTopRow}>
                ...
                <View style={[styles.cardStatusBadge, isLocked ? styles.cardBadgeLocked : styles.cardBadgeActive]}>
                  {isLocked ? <Lock size={11} color="#DC2626" /> : <CheckCircle2 size={11} color="#16A34A" />}
                  <Text style={[styles.cardStatusText, { color: isLocked ? '#DC2626' : '#16A34A' }]}>
                    {isLocked
              ...
              <View style={styles.cardChipRow}>
                ...
                <Wifi size={18} color="#94A3B8" style={{ transform: [{ rotate: '90deg' }] }} />
              </View>
              ...
              <View style={styles.cardBottomRow}>
                ...
                <View>
                  ...
                  <TouchableOpacity onPress={() => setShowCvv(!showCvv)} style={styles.cvvWrap}>
                    ...
                    {showCvv ? <EyeOff size={12} color="#94A3B8" /> : <Eye size={12} color="#94A3B8" />}
                  </TouchableOpacity>
                </View>
            ...
            <View style={[styles.freezeCard, isLocked && styles.freezeCardActive]}>
              <View style={styles.freezeLeft}>
                <View style={[styles.freezeIconWrap, { backgroundColor: isLocked ? '#FEE2E2' : '#F1F5F9' }]}>
                  {isLocked ? <Lock size={18} color="#DC2626" /> : <Unlock size={18} color="#475569" />}
                </View>
                <View style={{ flex: 1 }}>
            ...
            <View style={styles.togglesList}>
              ...
              <View style={styles.toggleRow}>
                <View style={styles.toggleLeft}>
                  <View style={[styles.toggleIconWrap, { backgroundColor: '#EFF6FF' }]}>
            ...
            <View style={styles.limitSelector}>
              {[25000, 50000, 100000].map((amt) => {
                ...
                return (
                  <TouchableOpacity
                    key={amt}
                    style={[styles.limitChip, isSelected && styles.limitChipSelected]}
                    onPress={() => {
                      setAtmLimit(amt);
                      showToast(
                        language === 'hi'
                    ...
                    activeOpacity={0.75}
                  >
                    <Text style={[styles.limitChipText, isSelected && styles.limitChipTextSelected]}>
            ...
            <View style={styles.actionButtonsRow}>
              ...
              <TouchableOpacity
                style={[styles.actionCardBtn, { borderColor: '#FCA5A5' }]}
                onPress={() => {
                  setIsLocked(true);
